...
type Subject struct {
	...
	TotalLessons       uint64         `gorm:"default:null" json:"total_lessons,omitempty"` // tổng số bài học
	...
	Center             Center         `gorm:"foreignKey:CenterId" json:"-"` // bắt buộc mỗi row trong fields phải có center_id
	Curriculums        []*Curriculum  `gorm:"many2many:curriculum_subjects" json:"curriculums,omitempty"`
	Lessons            []*Lesson      `json:"lessons,omitempty"`
	Category           *Category      `gorm:"foreignKey:CategoryId" json:"category,omitempty"` // có thể có hoặc không category_id
